...
priority; otherwise it randomly chooses among applicable recovery-item, armor, resisted-damage,
attached-slime, and nearby-crowd guidance when the killing enemy was not hit with a hammer, falling
back to a Progression-tab reminder. Resistance tips name the enemy's authored affinities with the same damage
