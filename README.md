...
**Blocks.** Grass, dirt, sand, stone, wood, and leaves are minable and placeable. A hoe converts
the exposed top face of grass or dirt into dry farmland, which drops dirt when mined. Seeded copper
...
`spawn copper <count>`. New worlds contain one seeded 5×4 pumpkin patch within forty blocks of the
