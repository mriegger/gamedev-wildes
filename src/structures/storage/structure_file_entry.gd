...
var identifier: StringName:
	get:
		return _identifier
var format: StructureDraft.Format:
	get:
		return _format
...
var _format: StructureDraft.Format
var _absolute_path: String

func _init(p_identifier: StringName, p_format: StructureDraft.Format, p_absolute_path: String) -> void:
