...
func _init(p_coord: Vector2i, p_generation: int, p_terrain_only: bool, p_generation_payload: Dictionary, p_terrain_mesh_data: Variant, p_water_mesh_data: Variant, p_foliage_mesh_data: Variant):
	coord = p_coord
