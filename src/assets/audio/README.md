...
- `combat/impacts/player/player_hit*.wav` provides three player-hit impact variations.
...
| `combat/impacts/player/player_hit*.wav` (3 files) | Muse, prompted by Michael Riegger | Project-authored | Player-hit impact variations. |
