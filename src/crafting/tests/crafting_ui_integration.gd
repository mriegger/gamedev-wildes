...
func _process(_delta: float) -> bool:
	...
	if _phase == 0 and _frame == 2:
		...
		_expect(_hud.inventory_ui_sound_player.stream == HUD.DEFAULT_UI_CLICK_SOUND, "Runes tab press did not play the default UI click")
		...
		_expect(_hud.inventory_ui_sound_player.stream == HUD.DEFAULT_UI_CLICK_SOUND, "Progression tab press did not play the default UI click")
		...
		_expect(_hud.inventory_ui_sound_player.stream == HUD.DEFAULT_UI_CLICK_SOUND, "Crafting tab press did not play the default UI click")
