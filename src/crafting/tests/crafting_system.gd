...
func _init() -> void:
	...
	progression_coordinator.setup(progression_inventory, recipe_catalog, progression_inventory.equipment_instance_factory)
	...
	general_coordinator.setup(anvil_inventory, recipe_catalog, anvil_inventory.equipment_instance_factory)
	...
	cauldron_coordinator.setup(cauldron_inventory, cauldron_recipe_catalog, cauldron_inventory.equipment_instance_factory)
	...
	hotbar_coordinator.setup(hotbar_only, anvil_recipe_catalog, hotbar_only.equipment_instance_factory)
	...
	backpack_first_coordinator.setup(backpack_first, recipe_catalog, backpack_first.equipment_instance_factory)
	...
	chest_coordinator.setup(chest_inventory, recipe_catalog, chest_inventory.equipment_instance_factory)
	...
	coordinator.setup(inventory, anvil_recipe_catalog, inventory.equipment_instance_factory)
	...
	crowded_coordinator.setup(crowded, anvil_recipe_catalog, crowded.equipment_instance_factory)
