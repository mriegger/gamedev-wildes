...
func _test_actor_movement_and_animation() -> SheepActor:
	...
	actor.tick_gameplay(behavior.idle_seconds, EntityTargetObservation.create(Vector3.ZERO, Vector3.ZERO, Vector3.FORWARD, Vector3.RIGHT), Vector3.ZERO, search_budget)
	for _step in range(4):
		search_budget.reset()
		actor.tick_gameplay(0.1, EntityTargetObservation.create(Vector3.ZERO, Vector3.ZERO, Vector3.FORWARD, Vector3.RIGHT), Vector3.ZERO, search_budget)
