...
func _init() -> void:
	...
	_expect(SaveManager.CURRENT_SAVE_VERSION == 19, "save version changed")
	...
	_expect(version_six.get("tutorial_progress", null) == TutorialProgress.new().snapshot(), "version six tutorial migration shape changed")
	...
	_expect(version_fourteen.get("tutorial_progress", null) == {"mining_tip_completed": true, "food_tip_completed": false, "crafting_tip_completed": false, "crafting_ingredients_tip_completed": false}, "version fourteen tutorial migration changed")
	...
	_expect(version_fifteen.get("tutorial_progress", null) == {"mining_tip_completed": false, "food_tip_completed": false, "crafting_tip_completed": false, "crafting_ingredients_tip_completed": false}, "version fifteen tutorial migration changed")
	...
	_expect(version_sixteen_with_food.get("tutorial_progress", null) == {"mining_tip_completed": false, "food_tip_completed": true, "crafting_tip_completed": false, "crafting_ingredients_tip_completed": false}, "version sixteen food history did not complete the tutorial")
	...
	_expect(version_seventeen.get("tutorial_progress", null) == {"mining_tip_completed": true, "food_tip_completed": true, "crafting_tip_completed": false, "crafting_ingredients_tip_completed": false}, "version seventeen crafting tutorial migration changed")
	...
	_expect(version_eighteen.get("tutorial_progress", null) == {"mining_tip_completed": true, "food_tip_completed": true, "crafting_tip_completed": true, "crafting_ingredients_tip_completed": false}, "version eighteen crafting ingredients tutorial migration changed")
	...
	if saved:
		...
		_expect(current_data.get("tutorial_progress", {}) == {"mining_tip_completed": true, "food_tip_completed": true, "crafting_tip_completed": true, "crafting_ingredients_tip_completed": true}, "current_data tutorial progress differs")
