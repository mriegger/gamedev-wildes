...
func _create_fixture(completed: bool, full_inventory: bool = false, item_ids: Array[StringName] = [&"apple"]) -> Dictionary:
	...
	_expect(progress.restore({"mining_tip_completed": true, "food_tip_completed": completed, "crafting_tip_completed": false, "crafting_ingredients_tip_completed": false, "copper_mining_tip_completed": false, "sundown_weapon_tip_completed": false, "damage_affinity_tip_completed": false}), "food tutorial progress setup failed")
