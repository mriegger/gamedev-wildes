...
func _test_progress_contract() -> void:
	...
	_expect(progress.restore({"mining_tip_completed": false, "food_tip_completed": false, "crafting_tip_completed": false, "crafting_ingredients_tip_completed": false, "copper_mining_tip_completed": false, "sundown_weapon_tip_completed": false}), "valid tutorial progress did not restore")
	...
	_expect(progress.snapshot() == {"mining_tip_completed": true, "food_tip_completed": false, "crafting_tip_completed": false, "crafting_ingredients_tip_completed": false, "copper_mining_tip_completed": false, "sundown_weapon_tip_completed": false}, "tutorial snapshot changed")
	...
	_expect(progress.snapshot() == {"mining_tip_completed": true, "food_tip_completed": true, "crafting_tip_completed": false, "crafting_ingredients_tip_completed": false, "copper_mining_tip_completed": false, "sundown_weapon_tip_completed": false}, "food tutorial snapshot changed")
	...
	_expect(progress.snapshot() == {"mining_tip_completed": true, "food_tip_completed": true, "crafting_tip_completed": true, "crafting_ingredients_tip_completed": false, "copper_mining_tip_completed": false, "sundown_weapon_tip_completed": false}, "crafting tutorial snapshot changed")
	...
	_expect(progress.snapshot() == {"mining_tip_completed": true, "food_tip_completed": true, "crafting_tip_completed": true, "crafting_ingredients_tip_completed": true, "copper_mining_tip_completed": false, "sundown_weapon_tip_completed": false}, "crafting ingredients tutorial snapshot changed")
	...
	_expect(progress.snapshot() == {"mining_tip_completed": true, "food_tip_completed": true, "crafting_tip_completed": true, "crafting_ingredients_tip_completed": true, "copper_mining_tip_completed": true, "sundown_weapon_tip_completed": false}, "copper mining tutorial snapshot changed")
	...
	_expect(progress.snapshot() == {"mining_tip_completed": true, "food_tip_completed": true, "crafting_tip_completed": true, "crafting_ingredients_tip_completed": true, "copper_mining_tip_completed": true, "sundown_weapon_tip_completed": true}, "sundown weapon tutorial snapshot changed")
...
func _create_fixture(completed: bool) -> Dictionary:
	...
	var progress := TutorialProgress.new()
	_expect(progress.restore({"mining_tip_completed": completed, "food_tip_completed": false, "crafting_tip_completed": false, "crafting_ingredients_tip_completed": false, "copper_mining_tip_completed": false, "sundown_weapon_tip_completed": false}), "fixture tutorial progress did not restore")
