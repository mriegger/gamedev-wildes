...
func _test_deterministic_drifting_roam() -> void:
	...
	first.advance(0.0, origin)
	second.advance(0.0, origin)
	...
	first.advance(behavior.roam_goal_seconds, drift_position)
	second.advance(behavior.roam_goal_seconds, drift_position)
