...
func _run() -> void:
	...
	var save_data := {
		...
		"item_proficiency": {},
		"tutorial_progress": {"mining_tip_completed": false, "food_tip_completed": false, "crafting_tip_completed": false, "crafting_ingredients_tip_completed": false, "copper_mining_tip_completed": false},
